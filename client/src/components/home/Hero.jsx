...
const Hero = () => {
    ...
    const logos = [
        ...
        'https://cdn.simpleicons.org/apple/64748b',
        'https://cdn.simpleicons.org/netflix/64748b',
        'https://cdn.simpleicons.org/meta/64748b',
        'https://cdn.simpleicons.org/spotify/64748b',
    ]
        ...
        <div className="min-h-screen pb-20">
            ...
            <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                ...
                <div className="flex gap-2">
                    {!user && (
                        <Link to="/app?state=register" className="hidden md:block px-6 py-2 bg-green-500 hover:bg-green-700 rounded-full text-white">
                            Get started
                        </Link>
                    )}
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                ...
                <button onClick={() => setMenuOpen(false)} className="active:ring-2 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-green-600 hover:bg-green-700 transition text-white rounded-md flex" >
                    X
                </button>
            </div>
            ...
            <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                ...
                <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                    Land Your Dream Job with AI  <span className=" bg-linear-to-r from-green-700 to-green-600 bg-clip-text text-transparent text-nowrap">AI Powered Resume </span> Components.
                </h1>
