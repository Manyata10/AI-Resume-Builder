            ...
            {data.map((experience, index) => (
                <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                    ...
                    <label className='flex items-center gap-2'>
                        <input type="checkbox" checked={experience.is_current || false} onChange={(e)=>{updateExperience(index, "is_current", e.target.checked ? true : false); }} className='focus:ring-blue-500' />
                    ...
                    <div className='space-y-2'>
                        ...
                        <div className='flex items-center justify-between'>
                        <label className='t' htmlFor="">Job Description</label>
        ...
        <AIAssistantModal 
            ...
            onApply={(suggestion) => {
                if (aiModalTarget !== null) {
                    updateExperience(aiModalTarget, "description", suggestion);
                }
            }} 
        />
    </div>
